...
- **Temporal *knowledge/reasoning* benchmarks.** TimeQA, TempReason, cross-calendar SPAN,
  "Dated Data" and domain-cutoff studies (effective vs reported cutoffs). These test what the
  model *knows* about time, and show it is largely unsolved (e.g. TimeQA best 46% vs human 87%).
